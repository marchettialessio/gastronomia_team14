...
public class Constants {
     ...
     */
    public static final String JSON_CONFIGURATION_PATH = "src/main/resources/com/museum/app/json/configuration.json";
     ...
     */
    public static final String DOWNLOAD_PATH = "src/main/resources/com/museum/app/json/downloaded_file.json";

    /*
     * path in cui salvare un file serializzato
     */
    public static final String SERIALIZE_PATH = "src/main/resources/com/museum/app/json/serialize_file.json";

    /*
     * path in cui salvare la lista di configurazioni salvate
     */
    public static final String AVAILABLE_CONFIGURATION_LIST_PATH = "src/main/resources/com/museum/app/json/available_configuration_file.txt";
